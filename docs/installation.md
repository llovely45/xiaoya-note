...
1.安装 Xiaoya aliyuntvtoken_connector -> 5 5 1
...
3.安装/更新 小雅助手（xiaoyahelper）-> 3 1

4.安装 115清理助手 -> 4 1 （如未配置115，跳过这步）

5.安装好后浏览器打开ip:5678，播放元数据目录下视频，确保可以播放，且115、阿里云盘至少有一个会员后再安装emby（如果只有115会员，需在脚本1-4配置7，并保存重启xiaoya。如果你只有阿里云盘三方权益，请见下文“六、常见问题”）
